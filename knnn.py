...
def KNiN(prueba):
  modeloknn=joblib.load("/home/kali/Escritorio/flask_app_tesis1/models/KNN_faiss_ver_oct.pkl")
  ...
  LabelEncoder()
  yy=le.inverse_transform(modeloknn.predict(norm))
  yu=pd.DataFrame(yy)
  ...
  return print(le.inverse_transform(modeloknn.predict(norm[:500])))
#benignos,ddos,goldeneye,hulk,slowhttptest,slowloris,
